    ...
    >
      <div className="flex flex-col gap-4 lg:flex-row lg:items-end lg:justify-between">
        ...
        <button
          ...
          className="inline-flex items-center justify-center gap-2 rounded-xl bg-emerald-600 px-4 py-2.5 text-xs font-semibold tracking-wide text-white shadow-sm transition-colors hover:bg-emerald-700 dark:bg-emerald-500 dark:hover:bg-emerald-400"
        >
      ...
      <div className="grid grid-cols-1 gap-6 lg:grid-cols-[minmax(0,1fr)_320px]">
        <div className="space-y-4">
          ...
          {postsLoading ? (
            ...
            <div className="rounded-2xl border border-stone-200 bg-white p-12 text-center dark:border-slate-800 dark:bg-slate-900">
            ...
            posts.map((post) => (
              <article key={post.id} className="rounded-2xl border border-stone-200 bg-white p-5 shadow-sm transition-colors hover:border-emerald-200 dark:border-slate-800 dark:bg-slate-900 dark:hover:border-emerald-500/30">
                ...
                {activePostIdForComments === post.id && (
                  <div className="mt-4 space-y-4 border-t border-stone-100 pt-4 dark:border-slate-800">
                    <div className="space-y-3 border-l-2 border-emerald-100 pl-4 dark:border-emerald-500/20">
                    ...
                    <form onSubmit={onAddComment} className="flex gap-2">
                      ...
                      />
                      <button type="submit" className="inline-flex items-center gap-2 rounded-xl bg-stone-900 px-4 py-2 text-xs font-semibold text-white dark:bg-emerald-600">
